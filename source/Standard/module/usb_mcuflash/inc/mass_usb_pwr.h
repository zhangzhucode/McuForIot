...
#ifndef __MASS_USB_PWR_H
#define __MASS_USB_PWR_H
/* Includes ------------------------------------------------------------------*/
#include "usb_core.h"
/* Exported types ------------------------------------------------------------*/
...
/* External variables --------------------------------------------------------*/
extern  __IO uint32_t Mass_bDeviceState; /* USB device status */
extern __IO FunctionalState Mass_fSuspendEnabled;  /* true when suspend is possible */
